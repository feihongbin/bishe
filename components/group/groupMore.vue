<template>
	<view class="more">
		<view class="moreList">
			...
			<view class="moreItem">
				<u-icon name="https://fhin-1308131188.cos.ap-nanjing.myqcloud.com/svg%2F%7DGOU%246(WJIX)~9E8_~%25TG4T.png" size="42"
					@click=""></u-icon><text></text>
			</view>
		<!-- 	<view class="moreItem">
